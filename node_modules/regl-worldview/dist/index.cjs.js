...
class WorldviewBase extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "_cameraListener", React.createRef());
  ...
  render() {
    ...
    const canvasHtml = canvas ? null : React.createElement(React.Fragment, null, React.createElement("canvas", {
      style: {
        width,
        height,
        maxWidth: "100%",
...
const Worldview = React.forwardRef((props, ref) => React.createElement(Dimensions, null, ({
  width,
  height,
  left,
  top
